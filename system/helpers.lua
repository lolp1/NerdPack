...
local ERR_SPELL_FAILED_S = _G.LE_GAME_ERR_SPELL_FAILED_S
local ERR_SPELL_OUT_OF_RANGE = _G.LE_GAME_ERR_SPELL_OUT_OF_RANGE
local ERR_SPELL_FAILED_ANOTHER_IN_PROGRESS = _G.LE_GAME_ERR_SPELL_FAILED_ANOTHER_IN_PROGRESS
local ERR_SPELL_COOLDOWN = _G.LE_GAME_ERR_SPELL_COOLDOWN
local ERR_ABILITY_COOLDOWN = _G.LE_GAME_ERR_ABILITY_COOLDOWN
local ERR_CANT_USE_ITEM = _G.LE_GAME_ERR_CANT_USE_ITEM
local ERR_ITEM_COOLDOWN = _G.LE_GAME_ERR_ITEM_COOLDOWN
local ERR_BADATTACKFACING = _G.LE_GAME_ERR_BADATTACKFACING
local ERR_NOT_WHILE_MOVING = _G.LE_GAME_ERR_NOT_WHILE_MOVING
